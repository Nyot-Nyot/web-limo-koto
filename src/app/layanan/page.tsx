      ...
      <div className="relative z-10 max-w-5xl mx-auto pt-24 px-4 md:px-0">
        ...
        <div className="mt-16 flex flex-col items-center w-full">
          <div className="flex flex-col md:flex-row gap-6 w-full justify-center mb-6">
            ...
            {/* Kontak Emergency */}
            <div className="bg-white/80 backdrop-blur-md rounded-xl shadow p-6 flex-1 min-w-[270px] max-w-md text-white">
              <h3 className="text-lg font-bold text-gray-900 mb-2">
                Kontak Emergency
              </h3>
              <div className="w-full h-[2px] bg-black mb-3 mt-1 rounded"></div>
              <ul className="text-sm text-gray-900 space-y-2">
                <li className="flex items-center gap-2">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M17 10h2.28a2 2 0 0 1 1.79 1.11l1.42 2.84A2 2 0 0 1 20.72 17H19"
                      stroke="#444"
                      strokeWidth="2"
                    />
                    <circle cx="6.5" cy="17.5" r="1.5" fill="#444" />
                    <circle cx="17.5" cy="17.5" r="1.5" fill="#444" />
                    <path stroke="#444" strokeWidth="2" d="M7 12h4m-2-2v4" />
                  </svg>
                  0823456789002
                </li>
                <li className="flex items-center gap-2">
